...
export interface GasPriceMinimum extends Contract {
    ...
    methods: {
        ...
        baseFeeOpCodeActivationBlock(): CeloTxObject<string>;
        deprecated_gasPriceMinimum(): CeloTxObject<string>;
        ...
        initialize(_registryAddress: string, _gasPriceMinimumFloor: number | string, _targetDensity: number | string, _adjustmentSpeed: number | string, _baseFeeOpCodeActivationBlock: number | string): CeloTxObject<void>;
        ...
        setBaseFeeOpCodeActivationBlock(_baseFeeOpCodeActivationBlock: number | string): CeloTxObject<void>;
