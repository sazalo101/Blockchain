...
exports.feeHandlerABI = void 0;
exports.feeHandlerABI = [
    {
        payable: false,
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'burning', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'DailyLimitHit',
    },
    {
        ...
        inputs: [
            ...
            { name: 'newLimit', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'DailyLimitSet',
    },
    {
    ...
    },
    {
        ...
        inputs: [
            { name: 'tokenAddress', internalType: 'address', type: 'address', indexed: false },
            { name: 'handlerAddress', internalType: 'address', type: 'address', indexed: false },
        ],
        name: 'TokenAdded',
    },
    {
        type: 'event',
        anonymous: false,
        inputs: [{ name: 'tokenAddress', internalType: 'address', type: 'address', indexed: false }],
        name: 'TokenRemoved',
    },
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'handlers', internalType: 'address[]', type: 'address[]' },
            { name: 'newLimits', internalType: 'uint256[]', type: 'uint256[]' },
            { name: 'newMaxSlippages', internalType: 'uint256[]', type: 'uint256[]' },
        ],
        name: 'initialize',
        outputs: [],
    },
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'handlerAddress', internalType: 'address', type: 'address' },
        ],
        name: 'addToken',
        outputs: [],
    },
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'newMax', internalType: 'uint256', type: 'uint256' },
        ],
    ...
    },
    {
        ...
        inputs: [
            { name: 'token', internalType: 'address', type: 'address' },
            { name: 'amountToBurn', internalType: 'uint256', type: 'uint256' },
        ],
