...
exports.newFeeCurrencyDirectory = exports.ABI = void 0;
exports.ABI = [
    {
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: 'intrinsicGas', type: 'uint256' },
        ],
...
function newFeeCurrencyDirectory(web3, address) {
    return new web3.eth.Contract(exports.ABI, address);
}
exports.newFeeCurrencyDirectory = newFeeCurrencyDirectory;
