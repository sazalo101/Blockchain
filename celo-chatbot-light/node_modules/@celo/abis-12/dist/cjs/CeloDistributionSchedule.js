...
exports.celoDistributionScheduleABI = void 0;
exports.celoDistributionScheduleABI = [
    {
    ...
    },
    {
        ...
        type: 'function',
        inputs: [],
        name: 'totalDistributedBySchedule',
        outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    },
    {
        stateMutability: 'nonpayable',
    ...
    },
    {
        ...
        type: 'function',
        inputs: [
            { name: '_l2StartTime', internalType: 'uint256', type: 'uint256' },
    ...
    },
    {
        ...
        type: 'function',
        inputs: [],
        name: 'distributeAccordingToSchedule',
        outputs: [{ name: '', internalType: 'bool', type: 'bool' }],
    },
    {
        stateMutability: 'view',
    ...
    },
    {
        ...
        type: 'function',
        inputs: [],
        name: 'getTotalDistributedBySchedule',
        outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    },
    {
    ...
    },
    {
        ...
        type: 'function',
        inputs: [],
        name: 'getRemainingBalanceToDistribute',
        outputs: [{ name: '', internalType: 'uint256', type: 'uint256' }],
    },
    {
        stateMutability: 'view',
    ...
    },
    {
        ...
        type: 'function',
        inputs: [],
        name: 'getTargetCeloDistribution',
        outputs: [
            { name: 'targetCeloDistribution', internalType: 'uint256', type: 'uint256' },
            { name: 'communityTargetRewards', internalType: 'uint256', type: 'uint256' },
            { name: 'carbonFundTargetRewards', internalType: 'uint256', type: 'uint256' },
        ],
    },
];
