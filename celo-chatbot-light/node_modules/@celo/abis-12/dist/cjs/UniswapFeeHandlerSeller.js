...
exports.uniswapFeeHandlerSellerABI = void 0;
exports.uniswapFeeHandlerSellerABI = [
    {
        payable: false,
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'minimumReports', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'tokneAddress', internalType: 'address', type: 'address', indexed: true },
            { name: 'router', internalType: 'address', type: 'address', indexed: true },
            { name: 'quote', internalType: 'uint256', type: 'uint256', indexed: false },
        ],
        name: 'ReceivedQuote',
    },
    {
    ...
    },
    {
        ...
        anonymous: false,
        inputs: [
            { name: 'soldTokenAddress', internalType: 'address', type: 'address', indexed: false },
            { name: 'boughtTokenAddress', internalType: 'address', type: 'address', indexed: false },
    ...
    { payable: true, stateMutability: 'payable', type: 'fallback' },
    {
        ...
        type: 'function',
        inputs: [
            { name: 'midPriceNumerator', internalType: 'uint256', type: 'uint256' },
            { name: 'midPriceDenominator', internalType: 'uint256', type: 'uint256' },
    ...
    },
    {
        ...
        inputs: [
            ...
            { name: 'newMininumReports', internalType: 'uint256[]', type: 'uint256[]' },
        ],
        name: 'initialize',
        outputs: [],
    },
    ...
    },
    {
        ...
        type: 'function',
        inputs: [
            { name: 'sellTokenAddress', internalType: 'address', type: 'address' },
            { name: 'buyTokenAddress', internalType: 'address', type: 'address' },
            { name: 'amount', internalType: 'uint256', type: 'uint256' },
            { name: 'maxSlippage', internalType: 'uint256', type: 'uint256' },
        ],
        name: 'sell',
