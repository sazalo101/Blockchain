...
export interface ExchangeEUR extends Contract {
    clone(): ExchangeEUR;
    methods: {
        ...
        initialize(registryAddress: string, stableTokenIdentifier: string, _spread: number | string, _reserveFraction: number | string, _updateFrequency: number | string, _minimumReports: number | string): CeloTxObject<void>;
...
export declare function newExchangeEUR(web3: Web3, address: string): ExchangeEUR;
