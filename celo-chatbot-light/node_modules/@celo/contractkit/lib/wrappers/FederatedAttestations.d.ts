import { FederatedAttestations } from '@celo/abis/web3/FederatedAttestations';
import { Address, CeloTransactionObject } from '@celo/connect';
import { BaseWrapper } from './BaseWrapper';
export declare class FederatedAttestationsWrapper extends BaseWrapper<FederatedAttestations> {
    /**
     ...
     */
    lookupIdentifiers: (account: Address, trustedIssuers: Address[]) => Promise<{
     ...
     * @dev Expectation that only one attestation exists per (identifier, issuer, account)
     */
    lookupAttestations: (identifier: string, trustedIssuers: Address[]) => Promise<{
        countsPerIssuer: string[];
        accounts: Address[];
        signers: Address[];
        issuedOns: string[];
     ...
     */
    validateAttestationSig: (identifier: string, issuer: Address, account: Address, signer: Address, issuedOn: number, v: number | string, r: string | number[], s: string | number[]) => Promise<void>;
    /**
     * @return keccak 256 of abi encoded parameters
     */
    getUniqueAttestationHash: (identifier: string, issuer: Address, account: Address, signer: Address, issuedOn: number) => Promise<string>;
    /**
     ...
     */
    registerAttestationAsIssuer: (identifier: string, account: Address, issuedOn: number) => CeloTransactionObject<void>;
    /**
     ...
     */
    revokeAttestation: (identifier: string, issuer: Address, account: Address) => CeloTransactionObject<void>;
    /**
     ...
     */
    batchRevokeAttestations: (issuer: Address, identifiers: string[], accounts: Address[]) => CeloTransactionObject<void>;
}
