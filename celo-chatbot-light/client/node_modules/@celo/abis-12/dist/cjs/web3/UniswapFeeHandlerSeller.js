...
exports.newUniswapFeeHandlerSeller = exports.ABI = void 0;
exports.ABI = [
    {
    ...
    },
    {
        ...
        inputs: [
            ...
            { internalType: 'uint256', name: 'newMininumReports', type: 'uint256' },
        ],
    ...
    },
    {
        constant: false,
        inputs: [
            { internalType: 'address', name: 'sellTokenAddress', type: 'address' },
            { internalType: 'address', name: 'buyTokenAddress', type: 'address' },
            { internalType: 'uint256', name: 'amount', type: 'uint256' },
            { internalType: 'uint256', name: 'maxSlippage', type: 'uint256' },
        ],
        name: 'sell',
...
function newUniswapFeeHandlerSeller(web3, address) {
    return new web3.eth.Contract(exports.ABI, address);
}
exports.newUniswapFeeHandlerSeller = newUniswapFeeHandlerSeller;
