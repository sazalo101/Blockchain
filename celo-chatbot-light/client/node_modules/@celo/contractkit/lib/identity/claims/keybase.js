...
function verifyKeybaseClaim(kit, claim, signer) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const hasValidSignature = yield metadata_1.IdentityMetadataWrapper.verifySignerForAddress(yield kit.contracts.getAccounts(), (0, claim_1.hashOfClaim)(parsedClaim.right.claim), parsedClaim.right.signature, signer);
