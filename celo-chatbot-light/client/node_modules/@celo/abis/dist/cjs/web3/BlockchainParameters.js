...
exports.newBlockchainParameters = exports.ABI = void 0;
exports.ABI = [
    {
    ...
    {
        anonymous: false,
        inputs: [{ indexed: false, internalType: 'uint256', name: 'gas', type: 'uint256' }],
    ...
    },
    {
        ...
        outputs: [
            ...
            { internalType: 'uint256', name: 'nextValue', type: 'uint256' },
            {
                internalType: 'uint256',
    ...
    },
    {
        ...
        inputs: [
            ...
            { internalType: 'uint256', name: 'lookbackWindow', type: 'uint256' },
        ],
        name: 'initialize',
        outputs: [],
        payable: false,
    ...
    {
        constant: false,
        inputs: [{ internalType: 'uint256', name: 'window', type: 'uint256' }],
    ...
    },
    {
        ...
        outputs: [{ internalType: 'uint256', name: 'lookbackWindow', type: 'uint256' }],
        payable: false,
        stateMutability: 'view',
        type: 'function',
    },
];
function newBlockchainParameters(web3, address) {
    return new web3.eth.Contract(exports.ABI, address);
}
exports.newBlockchainParameters = newBlockchainParameters;
