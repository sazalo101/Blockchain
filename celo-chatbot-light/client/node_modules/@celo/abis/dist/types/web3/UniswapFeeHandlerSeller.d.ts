...
export interface UniswapFeeHandlerSeller extends Contract {
    clone(): UniswapFeeHandlerSeller;
    methods: {
        ...
        removeRouter(token: string, router: string): CeloTxObject<void>;
...
export declare function newUniswapFeeHandlerSeller(web3: Web3, address: string): UniswapFeeHandlerSeller;
