...
export interface SortedOracles extends Contract {
    clone(): SortedOracles;
    methods: {
        breakerBox(): CeloTxObject<string>;
        equivalentTokens(arg0: string): CeloTxObject<string>;
        ...
        setBreakerBox(newBreakerBox: string): CeloTxObject<void>;
        ...
        setEquivalentToken(token: string, equivalentToken: string): CeloTxObject<void>;
        deleteEquivalentToken(token: string): CeloTxObject<void>;
        getEquivalentToken(token: string): CeloTxObject<string>;
        ...
        medianRateWithoutEquivalentMapping(token: string): CeloTxObject<{
            0: string;
            1: string;
        }>;
    ...
    events: {
        ...
        EquivalentTokenSet: ContractEvent<{
            token: string;
